...
export default function About() {
    ...
    return (
        <div id="about" className="h-screen w-screen about flex flex-col justify-evenly" style={{ overflowX: "auto" }}>
            <Typography className="text-center text-black inika text-5xl">
                What Makes us Different?
            </Typography>
            <Grid container className={`flex flex-nowrap overflow-x-auto gap-3 px-4 ${fadeIn ? 'animate-fade-right' : 'animate-fade-left'}`}>
