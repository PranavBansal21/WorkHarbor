...
const postedServices = [
    { workImg: "/Images/background.jpg", workTitle: "Furniture", tags: ["Carpenter", "Carpenter"], workDesc: "The leg of the table has be broken and the furniture needs to be refurbished" },
    { workImg: "/Images/background.jpg", workTitle: "Furniture", tags: ["Carpenter", "Carpenter"], workDesc: "The leg of the table has be broken and the furniture needs to be refurbished" },
    { workImg: "/Images/background.jpg", workTitle: "Furniture", tags: ["Carpenter", "Carpenter"], workDesc: "The leg of the table has be broken and the furniture needs to be refurbished" },
    { workImg: "/Images/background.jpg", workTitle: "Furniture", tags: ["Carpenter", "Carpenter"], workDesc: "The leg of the table has be broken and the furniture needs to be refurbished" },
    { workImg: "/Images/background.jpg", workTitle: "Furniture", tags: ["Carpenter", "Carpenter"], workDesc: "The leg of the table has be broken and the furniture needs to be refurbished" },
                ...
                <div className="px-10">
                    <Grid container>
                        <Grid item xs={8} className="ml-2 mt-5">
                            <InfoImage props={["/Images/back.jpg", "/Images/profilePic2.jpg"]} />
                        </Grid>
                    </Grid>
